                    ...
                    <div class="card premium-form-card border-0 rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap gap-4 mb-4">
                                <div>
                                    <h2 class="fw-bold form-title mb-2">Edit Food</h2>
                                    <p class="text-muted mb-0">Update your food item details and keep your menu fresh</p>
                                </div>

                                <div class="preview-image-wrapper">
                                    <img src="{{ $eatery->image ? asset('uploads/eatery/' . $eatery->image) : asset('images/default-eatery.jpg') }}"
                                        width="200" height="200" alt="{{ $eatery->name }}"
                                        class="rounded-4 preview-image shadow-sm">
                                </div>
                            </div>

                            <form action="{{ route('eatery.update', $eatery->sku) }}" method="post" enctype="multipart/form-data" class="mt-4 row g-4">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control premium-input" name="name" id="name"
                                        aria-describedby="helpId" value="{{ old('name', $eatery->name) }}" placeholder="Enter food name" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="any" class="form-control premium-input" name="price" id="price"
                                        aria-describedby="helpId" value="{{ old('price', $eatery->price) }}" placeholder="Enter price" />
                                ...
                                <div class="col-md-6">
                                    <label for="image" class="form-label premium-label">Replace Image</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" id="description" rows="8" class="form-control premium-input"
                                        placeholder="Write a short and tasty description...">{{ old('description', $eatery->description) }}</textarea>
